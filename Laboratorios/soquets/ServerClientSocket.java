...
import tcp.onEventLister;

public class ServerClientSocket extends Thread implements tcp.ServerClientSocket {
        ...
        while (this.isConnected) {
            try {
                ...
                if (data.getMsn().equals(":quit")) {
                    ...
                    ((Object) this.server).sendToRoom(room, data);
                }
     ...
     * // TODO Auto-generated method stub
     * throw new
     * UnsupportedOperationException("Unimplemented method 'addEventListener'");
     * }/*
     */
}
